           ...
           <div>
            ...
            <div className='flex flex-wrap w-full px-12 gap-4' >
                    ...
                    card.data.map((curr:any)=>{
                        return <div className='h-[300px] w-[300px]  rounded-sm' >
                           ...
                           <Popover>
                                            ...
                                            <CustomFieldform customId={curr._id} type='EDIT' useridclerk={data} />
                                                    </div>
                                                    <div className='h-16 border-b flex gap-2 items-center' >
                                                <DeleteSection deleteId={curr._id} type='CUSTOM' />
                                                    </div>
                ...
                <div className='h-[250px] w-[300px]  rounded-sm border-[2px] border-zinc-300 border-dashed flex flex-col justify-center items-center px-12' >
                    ...
                    <CustomFieldform type='ADD' useridclerk={data} customId={card._id} /> 
                    </div>
                    <h1 className='mt-4 font-medium text-center' >{card.heading}</h1>
                    <p className='text-[12px] font-normal text-zinc-600 text-center' >Add More {card.heading} </p>
