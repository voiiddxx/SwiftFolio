  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[300px]  md:max-w-full relative rounded-2xl border border-b-0 flex-shrink-0 border-slate-700 px-8 py-6 md:w-[450px]"
            style={{
              background:
          ...
          >
            <blockquote>
              ...
              ></div>
              <span className=" relative z-20 text-[10px] md:text-sm leading-[1.6] text-gray-700 font-normal ">
                {item.quote}
              </span>
