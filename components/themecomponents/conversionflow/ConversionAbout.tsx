...
const ConversionAbout = () => {
  return (
    <div className='min-h-screen w-full bg-white relative flex flex-col justify-center items-center' >
      {/* about heading */}
      <div className='w-full flex md:flex-row flex-col justify-between items-center md:px-32 pt-16' >
        <div className='w-1/2 ' >
        ...
        <div className='w-1/2  ' >
            <p className='text-gray-700 font-medium text-xl' >Over the past 12 years, I've worked with a diverse range of clients, from startups to Fortune 500 companies. I love crafting interfaces that delight users and help businesses grow.</p>
        </div>
