                    ...
                    return <div>
                        <div className='h-[500px] w-[500px] bg-white z-50 ' >
                            ...
                            <div className='py-5 px-4' >
                                <h1 className='bg-gradient-to-r from-violet-800 to-orange-800 text-transparent bg-clip-text text-lg font-medium' >Gitub Deployed</h1>
                                <h1 className='text-xl font-medium mt-4' >PlanetPulse(Eco-App)</h1>
